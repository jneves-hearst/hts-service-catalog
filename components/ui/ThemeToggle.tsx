...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg shadow-sm transition-all duration-200 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-hearst-500 bg-gray-900 text-yellow-300 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-white"
    >
