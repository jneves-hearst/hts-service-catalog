    ...
    <div className="flex min-h-screen flex-col">
      ...
      <footer className="relative overflow-hidden border-t border-gray-100 dark:border-gray-800">
        ...
        <div className="absolute inset-0 flex flex-wrap items-center justify-center gap-x-4 gap-y-1 px-6">
          ...
          <a
            href="#"
            className="text-xs text-gray-400 transition-colors hover:text-gray-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-hearst-500 dark:text-gray-500 dark:hover:text-gray-300"
          >
            Privacy Notice
          </a>
          <a
